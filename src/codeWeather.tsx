export const weatherCode = (code: number) => {
  ...
  return codeArray[code.toString()];
};

export const weatherCodeFullDay = (code: number) => {
  const codeArray: { [key: string]: string } = {
    "0": "Unknown",
    "1000": "Clear, Sunny",
    "1100": "Mostly Clear",
...
export const weatherCodeDay = (code: number) => {
  const codeArray: { [key: string]: string } = {
    "0": "Unknown",
    "10000": "Clear, Sunny",
    "11000": "Mostly Clear",
...
export const weatherCodeNight = (code: number) => {
  const codeArray: { [key: string]: string } = {
    "0": "Unknown",
    "10001": "Clear",
    "11001": "Mostly Clear",
